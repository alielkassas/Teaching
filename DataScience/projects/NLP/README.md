...
| *[Arabic Dialect Identification](https://github.com/qcri/QADI)* | It's a Country-level Arabic dialects identification (DI) dataset. It provides a collection for benchmarking DI task.The dataset contains 540,590 tweets from 18 Arab countries. More information about the dataset can be found in this [paper](https://paperswithcode.com/paper/qadi-arabic-dialect-identification-in-the).|
